...
curl -i -H "Content-Type: application/json" -X POST -d '{
    ...
    "title": "bhindi bhajee"
  }' https://salty-bastion-31857.herokuapp.com/gousto/api/v1.0/recipes
#add record
curl -i -H "Content-Type: application/json" -X POST -d '{
    "base": "pasta",
    "box_type": "gourmet",
...
curl -i -H "Content-Type: application/json" -X PUT -d '{
  ...
  }' https://salty-bastion-31857.herokuapp.com/gousto/api/v1.0/recipes/8
#update record
curl -i -H "Content-Type: application/json" -X PUT -d '{
    "base": "pasta",
    "box_type": "gourmet",
    ...
    "recipe_diet_type_id": "fish"
  }' https://salty-bastion-31857.herokuapp.com/gousto/api/v1.0/recipes/9
# update rating
curl -i -H "Content-Type: application/json" -X PUT -d '{
    "rating": 3
  }' https://salty-bastion-31857.herokuapp.com/gousto/api/v1.0/recipes/rating/8